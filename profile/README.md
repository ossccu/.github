# Constitution of the Open Source Software Community, City University (OSSCCU)
...
- **Foster an open-source culture**: Build a community where City University students embrace open-source values.  
- **Collaborative innovation**: Encourage teamwork on community-driven software projects.  
- **Skill development**: Develop skilled developers who can contribute to international projects.  
- **University representation**: Represent City University in national/international open-source events.  

## Mission

1. **Learning and contribution:** Provide workshops and hackathons on Git, Linux, and collaborative development tools. Encourage students to contribute to open-source repositories (e.g., through organized contribution sprints).  
2. **Project collaboration:** Facilitate student teams to create and maintain projects under OSSCCU’s GitHub organization, following open-source workflows (issues, pull requests, code reviews).  
3. **Community growth:** Host tech talks, mentoring sessions, and community events to grow membership and engagement.  
4. **Global engagement:** Help members participate in programs like Google Summer of Code or global hackathons, building portfolios.  
...
- Open to all City University students interested in software development and open-source.  
- Encourages participation from all programs, regardless of prior experience.
...
OSSCCU is managed by an **executive committee** elected or appointed for a one-year term. The committee members and roles are:

- **Convener (1 person):** Chief coordinator. Sets strategic vision, represents OSSCCU to the university, and approves major initiatives. (Analogous to a project founder or lead maintainer in open-source projects.)  
- **Joint Conveners (2 persons):** Assist the Convener in leadership. They help manage the community, coordinate major events, and step in when the Convener is unavailable.  
- **Member Secretary (1 person):** Administrative head. Manages records, communications, and documentation. Serves as a community “manager,” organizing calendars and meeting minutes.  
- **Joint Member Secretaries (2 persons):** Assist the Member Secretary. Handle communications (e.g., announcements, mailing lists) and help onboard new members.  
- **Organizing Secretary (1 person):** Event coordinator. Plans workshops, hackathons, and project sprints, handling logistics and outreach.  
...
These project roles are **defined by the committee** as needed; any member may assume them by appointment or volunteering.

## Alumni Mentors

**Alumni Mentors** (from the Computer Science & Engineering department) will be appointed annually. The Mentors:
- Guides OSSCCU’s activities to align with open source software policies.
- Helps mediate issues and projects with the committee.
- Provides support across academic years, ensuring institutional memory.
  
## Faculty Advisor

A **Faculty Advisor** (from the Computer Science & Engineering department) will be appointed annually. The advisor:  
- Guides OSSCCU’s activities to align with university policies.  
- Helps mediate issues and mentors the committee.  
- Provides continuity across academic years, ensuring institutional memory.

## Meetings and Events

- **Executive Committee Meetings:** Held at least once a month. Members discuss upcoming events, project status, and strategy. Minutes are recorded by the Member Secretary.  
- **General Meetings:** Quarterly or as needed for all members, to showcase projects, conduct training sessions, or hold elections.  
- **Workshops and Coding Sessions:** Frequent hands-on sessions on topics like Git workflows, open-source contribution, specific languages/frameworks.  

Community events include hackathons, collaborative coding days, and participation in national/international challenges. These align with open-source principles: collaboration, peer learning, and transparency.
...
- **Committee Selection:** New committee members are chosen Bimonthly/Triannual/Biannual/Annually. Selection may involve:  
  1. Nominations by current members or self-nomination.  
...
OSSCCU may partner with:  
- Other city tech clubs for joint events (e.g., robotics club on hardware-software projects).  
- National open-source organizations or student chapters.  
- Industry mentors and open-source foundations (arranging guest lectures or joint hackathons).  

These collaborations enrich OSSCCU’s activities and raise the university’s profile.

## Finances

- OSSCCU is funded by the University’s student activity funds or sponsorships (if applicable).  
- The committee follows university fiscal guidelines for any expenditures (approved by the Convener and faculty advisor).  
- All financial transactions are transparently recorded by the Member Secretary.

## Amendment of the Constitution

This constitution can be amended by a **two-thirds majority** of the executive committee members plus Faculty Advisor approval. Proposed amendments should be circulated to all members at least one week before a vote.

## Dissolution

OSSCCU may be dissolved if:  
1. A two-thirds majority of the executive committee votes for dissolution.  
2. The University administration mandates it.  

Upon dissolution, all documentation, code, and resources are handed over to the Department of Computer Science & Engineering or a successor student community at City University.
...
[1] [3] What is open source project governance? | Opensource.com
https://opensource.com/article/20/5/open-source-governance

[2] [5] What is the role of community managers in open-source?
https://milvus.io/ai-quick-reference/what-is-the-role-of-community-managers-in-opensource

[4] guides/building-leadership-in-an-open-source-community.md at master · todogroup/guides · GitHub
https://github.com/todogroup/guides/blob/master/building-leadership-in-an-open-source-community.md

[6] A guide to open source project governance models
